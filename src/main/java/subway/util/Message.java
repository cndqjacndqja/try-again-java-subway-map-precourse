...
public class Message {
	...
	public static String MESSAGE_FINISH_REGISTER_STATION = INFO_MESSAGE + "지하철 역이 등록 되었습니다.";
	public static String ERROR_MESSAGE_NOT_EXIST_STATION = ERROR_MESSAGE + "입력한 역이 존재하지 않습니다.";
	public static String SUCCESS_DELETE_STATION = INFO_MESSAGE + "지하철 역이 삭제 되었습니다.";
