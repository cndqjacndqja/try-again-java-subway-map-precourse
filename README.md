...
- [X] 4개의 선택지 입력
  - [X] 역 등록 시
    - [X] 등록할 역 이름 입력
      - [X] [ERROR] 중복된 지하철 역 이름입니다.
      - [X] [ERROR] 역 이름은 2글자 이상이어야 합니다.
      - [X] [INFO] 지하철 역이 등록 되었습니다.
  - [X] 역 삭제 시
    - [X] 삭제할 역 이름 입력
      - [X] [ERROR] 노선에 등록된 역은 삭제할 수 없습니다.
      - [X] [ERROR] 등록되지 않은 역입니다.
      - [X] [INFO] 지하철 역이 삭제 되었습니다.
  - [X] 역 조회 시
    - [X] [INFO] 역 목록 출력(한 줄에 하나씩)
  - [X] 돌아가기 선택 시 종료

### 노선 관리 화면
- [X] 4개의 선택지 출력
  - [X] 노선 등록 시
    - [X] [ERROR] 중복된 노선 이름입니다.
    - [X] [ERROR] 노선의 이름은 2글자 이상이어야 합니다.
      - [X] 등록할 노선의 상행 종점역 입력
      - [X] 등록할 노선의 하행 종점역 입력
        - [X] [ERROR] 상행 종점역과 하행 종점역이 같습니다.
- [X] 노선 삭제 시
  - [X] 삭제할 노선 이름 입력
    - [X] [ERROR] 존재하지 않는 노선입니다.
    - [X] [INFO] 지하철 노선이 삭제 되었습니다.
- [X] 노선 조회 시
  - [X] [INFO] 노선 목록 출력(한 줄에 하나씩)
